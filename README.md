...
### Celery Worker (tyre_match_celery_worker)
- Celery worker for asynchronous task handling

### Redis
- Requirement for celery worker
...
|── services/
|── tasks/
|── test-artifacts/  # Generated by test coverage
├── tests/
|    |── api/
|    |   └── routes/
|    |── helpers/
